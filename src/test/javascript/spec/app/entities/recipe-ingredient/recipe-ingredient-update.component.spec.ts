...
import RecipeIngredientUpdateComponent from '@/entities/recipe-ingredient/recipe-ingredient-update.vue';
import RecipeIngredientClass from '@/entities/recipe-ingredient/recipe-ingredient-update.component';
      ...
      wrapper = shallowMount<RecipeIngredientClass>(RecipeIngredientUpdateComponent, {
        ...
        provide: {
          ...
          measuringUnitService: () =>
            sinon.createStubInstance<MeasuringUnitService>(MeasuringUnitService, {
              retrieve: sinon.stub().resolves({}),
            } as any),
