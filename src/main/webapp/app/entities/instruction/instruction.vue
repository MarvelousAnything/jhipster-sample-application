<template>
  <div>
    <h2 id="page-heading" data-cy="InstructionHeading">
      <span id="instruction-heading">Instructions</span>
      ...
      <table class="table table-striped" aria-describedby="instructions">
        <thead>
          <tr>
            ...
            <th scope="row"><span>Step Number</span></th>
        ...
        <tbody>
          <tr v-for="instruction in instructions" :key="instruction.id" data-cy="entityTable">
            ...
            <td class="text-right">
              <div class="btn-group">
                <router-link :to="{ name: 'InstructionView', params: { instructionId: instruction.id } }" custom v-slot="{ navigate }">
                  <button @click="navigate" class="btn btn-info btn-sm details" data-cy="entityDetailsButton">
                    <font-awesome-icon icon="eye"></font-awesome-icon>
                    <span class="d-none d-md-inline">View</span>
                  </button>
                </router-link>
                <router-link :to="{ name: 'InstructionEdit', params: { instructionId: instruction.id } }" custom v-slot="{ navigate }">
                ...
                <b-button
                  v-on:click="prepareRemove(instruction)"
                  variant="danger"
                  class="btn btn-sm"
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span id="jhipsterSampleApplicationApp.instruction.delete.question" data-cy="instructionDeleteDialogHeading"
          >Confirm delete operation</span
        ></span
      >
      <div class="modal-body">
        <p id="jhi-delete-instruction-heading">Are you sure you want to delete this Instruction?</p>
      </div>
