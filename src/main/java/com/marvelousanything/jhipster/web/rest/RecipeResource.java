...
/**
 * REST controller for managing {@link com.marvelousanything.jhipster.domain.Recipe}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class RecipeResource {
    ...
    public ResponseEntity<Recipe> createRecipe(@Valid @RequestBody Recipe recipe) throws URISyntaxException {
        ...
        recipeSearchRepository.index(result);
    ...
    public List<Recipe> searchRecipes(@RequestParam String query) {
        ...
        return StreamSupport.stream(recipeSearchRepository.search(query).spliterator(), false).collect(Collectors.toList());
    }
}
